        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="assets/img/1.jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="assets/img/2.jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="assets/img/3.jpg" alt="Dummy Image" /></li>
                ...
                <div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/1.jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/2.jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/3.jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/6.jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/5.jpg" alt="Dummy Image" />
                            </div></li>
                    </ul>
                    <div class="slide-controller">
                        <a href="#" class="btn-prev"><img src="assets/img/previous.png"
                                                          alt="Prev Slide" /></a> <a href="#" class="btn-play"><img
                                src="assets/img/play.png" alt="Start Slide" /></a> <a href="#"
                                                                              class="btn-pause"><img src="assets/img/pause-button.png"
                                               alt="Pause Slide" /></a> <a href="#" class="btn-next"><img
                                src="assets/img/next.png" alt="Next Slide" /></a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
                            ...
                            <div class="item-info-product ">
                                ...
                                <div class="info-product-price">
                                    <input type="hidden" name="price"
                                           ...
                                           class="item_price"><%=retriveProduct.getString("price")%> ETB.</span>
